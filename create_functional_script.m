function create_functional_script(session_dir,subject_name,outDir,job_name,numRuns,filtType,lowHz,highHz,physio,motion,task,localWM,anat,dbDir)
...
for rr = 1:numRuns
    ...
    if ~localWM
        matlab_string = ([...
            '"register_feat(''$SESS'',''$SUBJ'',$runNum,1,''' func ''');' ...
